 ...
 * @author testi
 */
public abstract class Mandrokian extends NPCCommon implements Banditian {

    public Mandrokian(World world, int health, int maxHealth, int strength, Locality home, Weapon currentWeapon, Weapon secondCurrentWeapon, String name, long xp, int level, int skillPoints, CharacterState state, Set<Skill> skills, Position position) {
        ...
        this.setNPCBehaviour(new ProtectingBehaviour(Mandrokian.class));
    }

    public Mandrokian(World world, int level, Locality home, Weapon primary, Weapon secondary, String name) {
