 ...
 * @author testi
 */
public class HeilwelleRuneRezept extends RecipeCommon {
    ...
    public Map<Item, Integer> getRequiredResources() {
        ...
        hashMap.put(new Esperit(), 20);
        hashMap.put(new HeilwelleSpruchrolle(), 1);
    ...
    public Item getResult() {
        return new HeilwelleRune();
    }

    public String getName() {
        return "Rezept Rune Heilwelle";
    }
