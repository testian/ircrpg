 ...
 * @author testi
 */
public class HeilwelleRune extends ItemCommon {

    public String getName() {
        return "Rune Heilwelle";
    }
    ...
    public String itemInfo() {
        return super.itemInfo() + ". Für Magier mit mindestens 20% Erfahrung. Heilt ausnahmslos alle in einer Reichweite von 50 Metern um bis zu 200. Benötigt 100 Mana.";
    }
    ...
    return;
        ...
        m.increase(new Heilwelle().cast(user));
